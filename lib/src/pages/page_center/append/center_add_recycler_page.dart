...
//Diseño de la pantalla de añadir nuevo usuario(Centro de Acopio)

class CenterAddRecyclerPage extends StatefulWidget {
  @override
  _CenterAddRecyclerPageState createState() => _CenterAddRecyclerPageState();
}

class _CenterAddRecyclerPageState extends State<CenterAddRecyclerPage> {
